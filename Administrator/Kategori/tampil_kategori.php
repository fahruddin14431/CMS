	...
	<div class="panel-body">
		<?php 
			if($row = $result->num_rows<=0){
			 echo 'Data Tidak tersedia '.'<b><a href="index.php?master=tambah_kategori">Tambah Data</a></b>'; } else { ?>

		<a href="index.php?master=tambah_kategori" class="btn btn-success "><i class="fa fa-plus-circle"></i> Tambah</a>
		<br><br>
		<table id="table-data" class="table table-bordered table-striped table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="index.php?master=edit_kategori&ambil_id_kategori=<?php echo $row->id_kategori; ?>" class="btn btn-warning"><i class="fa fa-pencil-square"></i> Edit</a></td>
